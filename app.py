...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Văn Yến - Trường PTDTBT Tiểu học A Thượng Sơn - ĐT: 085 9456 538</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Văn Yến - Trường PTDTBT Tiểu học A Thượng Sơn- ĐT: 085 9456 538</div>", unsafe_allow_html=True)
